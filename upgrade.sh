...
echo $firmwares_name
wget "https://github.com/yeqifeng2288/OpenWRT-CI/releases/download/IPQ60XX-WIFI-YES-VIKINGYFY-main-${version}/VIKINGYFY-main-wifi-yes-qualcommax-ipq60xx-jdcloud_re-ss-01-squashfs-sysupgrade-${version}.bin" -O "/var/tmp/${firmwares_name}"
