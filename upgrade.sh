...
echo $firmwares_name
wget "https://github.com/yeqifeng2288/OpenWRT-CI/releases/download/IPQ60XX-WIFI-YES-VIKINGYFY-main-${version}/VIKINGYFY-main-qualcommax-ipq60xx-jdcloud_re-ss-01-squashfs-sysupgrade-${version}.bin" -O "/mnt/mmcblk0p27/backup/${firmwares_name}"
sysupgrade -F /mnt/mmcblk0p27/backup/${firmwares_name}
